...
class SteamSpider(scrapy.Spider):
    ...
    cookies = {
        ...
        'sessionid': '156c4f9a6afe2016bc38ab93',
        'Steam_Language': 'english',
        'steamCountry': 'CN%7C22a811fbd75798f1bbc28c37b7065273',
        'timezoneOffset': '28800,0',
        '_ga': 'GA1.2.1288366058.1506504681',
        '_gid': 'GA1.2.1170234144.1507271149',
        'steamLogin': '76561198073303687%7C%7CF63537B71C5C03B9EC1929BFE41D34DA102E5EC7'
    }
    ...
    headers = {
        ...
        'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.78 Safari/537.36'
    }
    ...
    def parse(self, response):
        ...
        for info in info_grp:
            item = SteamItem()
            rmb_str = info.xpath('div[contains(@class, "market_listing_row")]/div[contains(@class, "market_listing_price_listings_block")]/div[contains(@class, "market_listing_right_cell")]/span[contains(@class, "market_table_value")]/span[@class="normal_price"]/text()').extract()[0]
            ...
            item['item_price'] = rmb
            item['item_name'] = info.xpath('div[contains(@class, "market_listing_row")]/div[contains(@class, "market_listing_item_name_block")]/span[@class="market_listing_item_name"]/text()').extract()[0].strip()
            yield item
